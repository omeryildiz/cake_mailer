<div class="messages index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('Konusu'); ?></th>
			<th><?php echo $this->Paginator->sort('Mesaj'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($message['Message']['Konusu']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['Mesaj']); ?>&nbsp;</td>
		<td class="actions">
